...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    private final List<Match> matches; //listar as partidas

    public MatchesAdapter(List<Match> matches) { //receber as listas como parametro
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.binding.tvAwayTeamScore.setText(match.getAwayTeam().getName());
